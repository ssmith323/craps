...
export type HARDWAYS_WORDS_TYPE = 'four' | 'six' | 'eight' | 'ten'

export const HARDWAYS_NUMBERS: HARDWAYS_NUMBERS_TYPE[] = [4, 6, 8, 10]
export const HARDWAYS_BETS = new Map<
  HARDWAYS_NUMBERS_TYPE,
  HARDWAYS_WORDS_TYPE
>([
  [4, 'four'],
  [6, 'six'],
